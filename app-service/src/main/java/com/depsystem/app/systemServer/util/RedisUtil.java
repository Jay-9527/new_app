...
public final class RedisUtil {
    ...
    private static final RedisTemplate<String, Object> redisTemplate = SpringUtil
    ...
    /**
     * 将redis取出来的Object对象转成指定对象
     * @param o object
     * @param c class
     * @return 泛型
     * @param <T> 泛型
     */
    public <T> T convertToObjects(Object o, Class<T> c) {
        return JSONObject.toJavaObject(JSONObject.parseObject(JSONObject.toJSONString(o)), c);
    }
    ...
    /**
     * 对zset的score操作，如果存在则增加减少increment，如果不存在则直接添加到zset中
     *
     * @param key key
     * @param increment in
     * @param member member
     * @return 返回操作后的score，若不存在返回null;
     */
    ...
    public Long removeZSetMember(String key, Object obj) {
